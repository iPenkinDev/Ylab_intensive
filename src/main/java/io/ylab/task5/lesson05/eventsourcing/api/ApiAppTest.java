...
public class ApiAppTest {
    ...
    public ApiAppTest(Channel channel, ConnectionFactory connectionFactory, PersonApi personApi) {
    ...
    @PostConstruct
    void onStart() throws IOException, TimeoutException, InterruptedException {
    ...
    private void fifoTest() throws InterruptedException {
        clearDb();
        Thread.sleep(1000L);
